...
(function() {
  ...
  BANNER = 'Usage: cozy [options] path/to/script.cozy -- [args]\n\nIf called without options, `cozy` will run your script.';
  ...
  compilePath = function(source, topLevel, base) {
    return fs.stat(source, function(err, stats) {
      ...
      if ((err != null ? err.code : void 0) === 'ENOENT') {
        if (topLevel && source.slice(-7) !== '.cozy') {
          source = sources[sources.indexOf(source)] = "" + source + ".cozy";
      ...
      } else if (topLevel || path.extname(source) === '.cozy') {
        if (opts.watch) {
          watch(source, base);
        }
  ...
  compileScript = function(file, input, base) {
    ...
    try {
      ...
      message = helpers.prettyErrorMessage(err, file || '[stdin]');
      printWarn(message);
  ...
  version = function() {
    return printLine("CozyScript version " + CoffeeScript.VERSION);
  };
