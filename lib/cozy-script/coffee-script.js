...
(function() {
  ...
  if (require.extensions) {
    require.extensions['.cozy'] = function(module, filename) {
      var content;
  ...
  exports.compile = compile = function(code, options) {
    ...
    header = "Generated by CozyScript " + this.VERSION;
    return "// " + header + "\n" + js;
  };
  ...
  exports.run = function(code, options) {
    ...
    if (path.extname(mainModule.filename) !== '.cozy' || require.extensions) {
