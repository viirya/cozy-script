...
(function() {
  var Access, Arr, Assign, BackCall, Base, Block, Call, Class, Closure, Code, Comment, Currying, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Undefined, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, some, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Undefined = Undefined = (function(_super) {
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.filterImplicitBackCall = function(backcall) {
      var findIt, node, nodes, _i, _len, _ref2;
      nodes = [];
      findIt = false;
      _ref2 = this.args;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        node = _ref2[_i];
        if (node instanceof Value && node.base instanceof Literal && node.base.value === '_') {
          nodes.push(backcall);
          findIt = true;
        } else {
          nodes.push(node);
    ...
    Call.prototype.filterImplicitArguments = function(list) {
      var arg_index, node, nodes, _i, _len;
      this.partial = false;
      nodes = [];
      this.where = [];
      arg_index = 0;
    ...
    Call.prototype.compileNode = function(o) {
      ...
      args = this.filterImplicitArguments(args);
      args = ((function() {
      ...
      if (this.partial) {
        ...
        utility('partialize');
        if (this.isSuper) {
          args = "[" + (this.superThis(o)) + ", " + args + "], [" + where + "]";
          return "__partialize.apply(this, [" + (this.superReference(o)) + ".call, " + args + "])";
        } else {
          args = "[" + args + "], [" + where + "]";
          return (this.isNew ? 'new ' : '') + ("__partialize.apply(this, [" + (this.variable.compile(o, LEVEL_ACCESS)) + ", " + args + "])");
        }
      } else {
        if (this.isSuper) {
  ...
  exports.BackCall = BackCall = (function(_super) {

    __extends(BackCall, _super);

    function BackCall(call, backcall) {
      this.call = call;
      this.backcall = backcall;
    }

    BackCall.prototype.children = ['call', 'backcall'];

    BackCall.prototype.compileNode = function(o) {
      this.call.filterImplicitBackCall(this.backcall);
      return this.call.compileNode(o);
    };

    BackCall.prototype.compileSuper = function(args, o) {
      return this.call.compileSuper(args, o);
    };

    BackCall.prototype.compileSplat = function(o, splatArgs) {
      return this.call.compileSplat(o, splatArgs);
    };
  ...
  exports.Currying = Currying = (function(_super) {

    __extends(Currying, _super);

    function Currying() {}

    Currying.prototype.compileNode = function(o) {
      utility('currying');
      return '';
    };
  ...
  exports.Code = Code = (function(_super) {
    ...
    function Code(params, body, tag, currying) {
      var _ref2;
      this.params = params || [];
      ...
      this.currying = (_ref2 = currying === 'yes') != null ? _ref2 : {
        "true": false
      };
    }
